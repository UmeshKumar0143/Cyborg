  ...
  return (
    <div className='mt-10 '>
        <div className='ml-3'>
         ...
         <div className='flex xl:ml-52 flex-wrap sm:gap-5  '>
       {Teams.map((item,index)=>  <div key={index} className='w-[276px] mt-10 ml-10 xl:ml-0 h-[355px] flex flex-col justify-center items-center border-2 rounded-xl'>
